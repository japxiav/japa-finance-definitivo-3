# Japa Finance v0.9 Alpha 2 — Classificação utilizável
...
- o estado usa `schemaVersion: 7`, com migração automática das versões anteriores.
...
- a v0.8 introduziu `schemaVersion: 5`; a Alpha 1 usou a versão 6 e a Alpha 2 migra o estado para `schemaVersion: 7`;
...
A Alpha 2 foi revisada sem executar npm, Vitest, build Vite, Supabase ou E2E.
